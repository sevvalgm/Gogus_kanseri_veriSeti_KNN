...
#(2) Makine Öğrenmesi Modelinin Seçilmesi -KNN Sınıflandırması 
...
knn.fit(X_train, y_train) #fit fonksiyonu verimizi (samples + target) kullanarak knn algoritmasını eğitiir.
...
#(5) Hiperparametre Ayarlanması [amaç doğruluğu arttırmak]

#KNN: Hyperparametresi = K 
 #K= 1,2,3 ....  N 
 #Accuracy: %A, %8, %C ....
accuracy_values= []
k_values= []
...
# %% kendimiz oluşturduk veri setini
